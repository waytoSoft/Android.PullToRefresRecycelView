...
public class RecyclerViewDisabledRefreshActivity extends AppCompatActivity implements PullToRefreshRecyclerViewListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 0x10:
                    ...
                    recyclerView.setMode(PullToRefresRecyclerView.Mode.DISABLED);
                    break;
            }
        }
    };
